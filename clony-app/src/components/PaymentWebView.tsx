...
import { View, Modal, ActivityIndicator, Alert, Platform, Text, TouchableOpacity } from 'react-native';
    ...
    return (
      <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
        <View className="flex-1 bg-white items-center justify-center p-8">
          <Text className="text-xl font-bold mb-4">웹에서는 결제를 지원하지 않습니다.</Text>
          <TouchableOpacity
            onPress={onClose}
            className="bg-clony-primary px-8 py-3 rounded-xl"
          >
